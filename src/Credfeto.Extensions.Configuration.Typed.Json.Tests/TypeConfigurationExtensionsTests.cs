...
public sealed class TypeConfigurationExtensionsTests : LoggingTestBase
{
    ...
    public void SimpleObjectWithOneNullableStringPropertyIsValidNull()
    {
        IOptions<SimpleObjectWithOneNullableStringProperty> configuration = GetSetting(
            new Dictionary<string, string?>(StringComparer.Ordinal) { ["banana:name"] = null },
            sectionKey: "banana",
    ...
    {
        IOptions<SimpleObjectWithOneInt32Property> configuration = GetSetting(
            new Dictionary<string, string?>(StringComparer.Ordinal) { ["banana:expected"] = "42" },
            sectionKey: "banana",
    ...
    {
        IOptions<SimpleObjectWithOneInt64Property> configuration = GetSetting(
            new Dictionary<string, string?>(StringComparer.Ordinal) { ["banana:expected"] = "42" },
            sectionKey: "banana",
    ...
    {
        IOptions<SimpleObjectWithOneUInt32Property> configuration = GetSetting(
            new Dictionary<string, string?>(StringComparer.Ordinal) { ["banana:expected"] = "42" },
            sectionKey: "banana",
    ...
    {
        IOptions<SimpleObjectWithOneUInt64Property> configuration = GetSetting(
            new Dictionary<string, string?>(StringComparer.Ordinal) { ["banana:expected"] = "42" },
            sectionKey: "banana",
    ...
    private static IOptions<TConfigurationType> GetSetting<TConfigurationType>(
        IDictionary<string, string?> settings,
        string sectionKey,
        IValidator<TConfigurationType> validator
    )
    ...
    private static IServiceProvider BuildServiceProvider<TConfigurationType>(
        IDictionary<string, string?> settings,
        string sectionKey,
        IValidator<TConfigurationType> validator
    )
